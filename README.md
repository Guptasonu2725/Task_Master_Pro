...
✔️ Search tasks in real time

✔️ Category filters (All, Today, Upcoming, Completed)

✔️ Modern UI with gradient toolbar
...
1. Clone the repository
       ...
       git clone https://github.com/Guptasonu2725/TaskMasterPro.git
